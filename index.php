...
<div id="app">
    <div class="container text-center mt-3">
        <div class="row">
            <div class="col">
                <p class="p-1 text-muted "> სულ: {{all.length}} 
                    <a title="საკვების დამატება" target="_blank" href="https://forms.gle/cn13LYhG7iUUCCEe9"> + </a>
                </p>
            </div>
            ...
            <div class="col">
                <p class="p-1 text-muted"> <label for="show_img"> სურათების ჩვენება </label> <input id="show_img" type="checkbox" v-model="show_img"></p>
            </div>
        </div>
        <div class="row">
            <div class="col pb-5">
        ...
        <div class="row">
            <div class="col clean">
                ...
                <clean :allfood="all" :show_img="show_img" :clean="true"></clean>
            </div>
            <div class="col unclean">
                <h1 class="title">უწმიდური</h1>
                <clean :allfood="all" :show_img="show_img" :clean="false"></clean>
            </div>
        </div>
    </div>

<a target="_blank" href="https://en.wikibooks.org/wiki/Hebrew_Roots/Unclean_foods/Unclean_Animal_Food_List">link</a>
<a target="_blank" href="http://www.bible.com.ua/answers/r/17/306138">link_ru</a>
</div>
